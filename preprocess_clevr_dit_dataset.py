"""
Preprocess CLEVR scenes into a 3-object text-conditioned DiT dataset.

This stage stores structured object and spatial metadata. Caption strings and
FLAN-T5 embeddings can be regenerated later from the metadata.
"""
import argparse
import json
import os
...
def main(args):
    ...
    readme = (
        ...
        "FLAN-T5 embeddings are generated by `preprocess_clevr_text_embeddings.py`.\n"
    )
